...
class Cuenta(ABC):
    def __init__(self, nombre, apellido, cantidad, saldo, operaciones):
        while True:
    ...
    def mostrar(self):
        print("Nombre del titular: {} {} cantidad en cuenta: {}".format(self.nombre, self.apellido, self.cantidad))
        pass
...
nueva_cuenta = Cuenta("","", 0.00, 0.00, 0)
    ...
    def mostrar_joven(self):
        while True:
            if self.titular_valido == True:
                ...
                print ("Cuenta Joven con una bonificacion de {}%".format(self.bonificacion))
                break
            else:
                break
        pass
